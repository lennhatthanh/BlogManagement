        ...
        <div className="container mx-auto py-4 fixed top-0 bg-background z-40 right-0 left-0">
            <div className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32">
                ...
                <div className="flex gap-2">
                    ...
                    {theme === "light" ? (
                        <Button onClick={handleTheme} className="bg-transparent hover:bg-accent text-black">
                            <svg
                        ...
                        <Button onClick={handleTheme} className="bg-transparent hover:bg-accent text-white">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
